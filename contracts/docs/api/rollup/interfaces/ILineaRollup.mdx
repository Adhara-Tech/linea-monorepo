...
Adds or updates the messaging service contract address.
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| _newMessagingAddress | address | The address for the messaging contract to update during block finalization. |
