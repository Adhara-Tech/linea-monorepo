...
### _anchorL1L2MessageHashes

```solidity
function _anchorL1L2MessageHashes(bytes32[] _messageHashes, uint256 _startingMessageNumber, uint256 _finalMessageNumber, bytes32 _finalRollingHash) internal
```
